...
luxurious_lamp_price_disccount = luxurious_lamp_price - (luxurious_lamp_price*0.2)
lovely_loveseat_price_disccount = lovely_loveseat_price - (lovely_loveseat_price*0.15)

customer_two_total = 0
customer_two_itemization = ""

customer_two_total += stylish_settee_price * 2
customer_two_total += lovely_loveseat_price_disccount * 4
customer_two_total += luxurious_lamp_price - luxurious_lamp_price_disccount
